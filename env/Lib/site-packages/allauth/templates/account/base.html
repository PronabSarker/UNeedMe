    ...
    <div class="container"><a class="navbar-brand" href="{% url 'index' %}" style="color: white;" >UNeedMe</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
        <div class="collapse navbar-collapse"
            ...
            <span class="navbar-text actions">
              ...
              <a class="btn btn-light action-button" role="button" href="/accounts/logout">Sign out</a> 
              {% else %}
              <a class="login" style="color: white;" href="/accounts/login">Sign In</a> 
      ...
      <div>
        ...
        <!-- Footer Links -->
        <div class="footer-dark" style="background-color:black; padding-top: 100px;">
          <footer>
              <div class="container">
                  <div class="row">
